...
-- 按 leader 1 打开文件树
vim.keybinds.gmap("n", "<leader>nt", "<cmd>NvimTreeToggle<CR>", vim.keybinds.opts)
-- 按 leader fc 在文件树中找到当前以打开文件的位置
vim.keybinds.gmap("n", "<leader>fc", "<cmd>NvimTreeFindFile<CR>", vim.keybinds.opts)
-- 按 leader ff 将光标从定位到nvimtree上
--vim.keybinds.gmap("n", "<leader>nf", "<cmd>NvimTreeFocus<CR>", vim.keybinds.opts)
